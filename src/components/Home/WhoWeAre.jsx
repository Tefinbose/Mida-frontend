        ...
        <ScrollReveal delay={0.2}>
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-4 rounded-2xl bg-[#1597A8] p-6 text-white shadow-xl md:right-6">
              ...
              <h3 className="mt-3 text-2xl font-bold">Around The Globe</h3>
        ...
        <ScrollReveal delay={0.4}>
          <div>
            ...
            <p className="mt-6 leading-relaxed text-gray-600">
              From weekend getaways to a fun-packed trip calendar, adventure and
              amazement are the essence of life. Let us help you tick off your
              bucket list, one unforgettable journey at a time.
            </p>

            <p className="mt-4 leading-relaxed text-gray-600">
              At Mida Travels, we are passionate about creating extraordinary
              travel experiences that connect people with destinations,
